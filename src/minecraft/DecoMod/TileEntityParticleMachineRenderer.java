...
public class TileEntityParticleMachineRenderer extends TileEntitySpecialRenderer // because your block is, and you are too.
{
private ModelParticleMachine model; // yup, this refers to the last file. so you'll get an error for now. it says what model it has to take. you could also make it a boat, or a cow. nice for statues or something. have it render the model of a cow.
...
{
i =(tile.worldObj.getBlockMetadata(tile.xCoord, tile.yCoord, tile.zCoord)); // to the the game it needs to pick up metadata from your block
}
